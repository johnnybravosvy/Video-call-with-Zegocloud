                ...
                <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="grid items-center grid-cols-1 xl:grid-cols-2">
                        ...
                        >
                            ...
                            >
                                Customers and brands love using A-Video
                            </h2>
                            <p className="mt-6 text-lg font-normal text-gray-600 font-pj">
                                Our customers and brands love using A-Video to create, sell, and keep up with their clients and also staff. This has helped them to increase their sales and also improve their customer service.
                            </p>
                        </div>
